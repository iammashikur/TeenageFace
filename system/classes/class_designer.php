...
class designer
{
    ...
    public function loadLogo()
    {
        ...
        if ($D->_IS_LOGGED) {
            ...
            $the_logo .= '<div id="logo"><span id="logo-normal"><img src="'. getImageTheme('tlogo.png') .'"></span><span id="logo-mini"><span id="for-menu-resp"><img src="'. getImageTheme('top-moredash.png') .'"></span></span></div>';
        } else {
            $the_logo .= '<a href="'. $K->SITE_URL .'" title="'. htmlspecialchars($K->SITE_TITLE) .'">';
            $the_logo .= '<div id="logo"><span id="logo-normal"><img src="'. getImageTheme('tlogo.png') .'"></span><span id="logo-mini"><img src="'. getImageTheme('logo-mini.png') .'"></span></div>';
        }
        $the_logo .= '</a>';
        return $the_logo;
    }
    ...
    {
        global $K;
        $the_favicon = '    <link href="'. getImageTheme('favicon.png') .'" rel="shortcut icon" />'."\n";
        return $the_favicon;
    }
